...
alias mandeye_fake_pps_start="sudo systemctl start mandeye_fake_pps.service"
alias mandeye_fake_pps_stop="sudo systemctl stop mandeye_fake_pps.service"
alias mandeye_fake_pps_status="sudo systemctl status mandeye_fake_pps.service"
alias mandeye_fake_pps_log="journalctl -u mandeye_fake_pps.service"
